...
class RestaurantServiceTest {
    ...
    @BeforeEach
    public void test_restaurant_service(){
    ...
    public void searching_for_existing_restaurant_should_return_expected_restaurant_object() throws restaurantNotFoundException {
        ...
        //Tested that it works by mocking as well without creating actual restaurant object
    ...
    public void searching_for_non_existing_restaurant_should_throw_exception() throws restaurantNotFoundException {
        ...
        List<Restaurant> restaurants = service.getRestaurants();
        restaurants.add(restaurant);
        assertThrows(restaurantNotFoundException.class,()->service.findRestaurantByName("Amelies cafe").getName());
